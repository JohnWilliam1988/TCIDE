...
#include "XInfoTipDebug.h"		// Class interface
#include "TCDoc.h"
#include "TCView.h"
...
// Message map
BEGIN_MESSAGE_MAP(CXInfoTipDebug, CWnd)
...
//     
/////////////////////////////////////////////////////////////////////
BOOL CXInfoTipDebug::Create(CWnd* pParentWnd) 
{
	BOOL	bSuccess;
    ...
    logFont.lfWeight = 16; //20;
    logFont.lfHeight = 14; //16;
    lstrcat(logFont.lfFaceName, _T("ËÎÌו"));
...
//     
/////////////////////////////////////////////////////////////////////
void CXInfoTipDebug::Show(CString szText, CPoint *pt /* = NULL */)
{
	if (pt != NULL)
		m_ptOrigin	= *pt;
	else
...
void CXInfoTipDebug::OnPaint() 
{
	...
	WindowBrush.CreateSolidBrush(RGB(251,237,187)/*0x00ffff*//*::GetSysColor(COLOR_WINDOW)*/);
...
//     
/////////////////////////////////////////////////////////////////////
BOOL CXInfoTipDebug::GetWindowRegion(CDC* pDC, HRGN* hRegion, CSize *Size /* = NULL */)
{
	CRect	rcWnd;
	POINT	ptLeader[3];
	CRgn	LeaderRegion;
	...
	ptLeader[1].x	= rcWnd.Width() - CX_ROUNDED;
	ptLeader[1].y	= rcWnd.Height() - CY_ROUNDED;

	ptLeader[2].x	= rcWnd.Width() - CX_ROUNDED;
	ptLeader[2].y	= rcWnd.Height() - CY_ROUNDED;

	// Create the caption region
	CaptionRegion.CreateRoundRectRgn(0, 0, rcWnd.Width()-8, rcWnd.Height()-8, CX_ROUNDED, CY_ROUNDED);
...
//     
/////////////////////////////////////////////////////////////////////
int CXInfoTipDebug::OnCreate( LPCREATESTRUCT lpCreateStruct ) 
{
...
//     
/////////////////////////////////////////////////////////////////////
void CXInfoTipDebug::OnTimer( UINT nIDEvent ) 
{
	HRGN	hRegion;
	CSize	WindowSize;
	CDC		*pDC;
...
//     
/////////////////////////////////////////////////////////////////////
void CXInfoTipDebug::RelayEvent(LPMSG lpMsg)
{
	CPoint			point;
	CWnd			*pWindow;
...
//     
/////////////////////////////////////////////////////////////////////
void CXInfoTipDebug::SetIcon(HICON hIcon) 
{
	ICONINFO	IconInfo;
	m_hIcon = hIcon; 
...
//     
/////////////////////////////////////////////////////////////////////
void CXInfoTipDebug::AddTool(CWnd *pWnd, LPCTSTR szTooltipText, HICON hIcon /* = NULL */)
{
	ASSERT(pWnd != NULL);
...
//     
/////////////////////////////////////////////////////////////////////
void CXInfoTipDebug::RemoveTool(CWnd *pWnd)
{

...
public:
    ...
    BOOL Create(const RECT& rect, CWnd* parent, UINT nID,
                DWORD dwStyle = WS_CHILD | WS_BORDER | WS_TABSTOP | WS_VISIBLE | WS_CLIPSIBLINGS);
...
public:
	...
	//4-7号小亮添加方法
	bool IsShowVertiLines();
	bool IsShowHorizLines();
	BOOL TCGetExpandToFit()						  { return m_bExpandToFit;			  }
...
public:
	...
	//设置列的只读属性相关
	BOOL  TCSetColReadInfo(int nRow, int nCol, BOOL reOnly);
	BOOL  TCGetColReadInfo(int nRow, int nCol);

///////////////////////////////////////////////////////////////////////////////////
// 4-14号添加事件相关
///////////////////////////////////////////////////////////////////////////////////
	CString TCGetClickEvent();		
	CString TCGetBeforeEditEvent();	
	CString TCGetAfterEditEvent();
	CString TCGetHeadSortEvent();
	void    TCSetAllSellsEditAbled(BOOL editAble);

	void	TCSetClickEvent(CString click);
	void	TCSetBeforeEditEvent(CString befor);
	void    TCSetAfterEditEvent(CString after);
	void    TCSetHeadSortEvent(CString headsort);
	BOOL	TCGetAllSellsEditAbled()			{	return m_allCellsEditAbled;		}
///////////////////////////////////////////////////////////////////////////////////
// Operations
///////////////////////////////////////////////////////////////////////////////////
public:
...
protected:
	...
	//GridCtrl的事件
	CString     m_eClicked;									//左键单击
	CString     m_eBeforeEdit;								//开始编辑
	CString     m_eAfterEdit;								//结束编辑
	CString     m_eClickHeadSort;							//点击排序
	BOOL		m_allCellsEditAbled;								//所有项可编辑
    ...
    BOOL        m_bFrameFocus;
	BOOL		m_bExpandToFit;								//4-18号添加是否自适应大小变量

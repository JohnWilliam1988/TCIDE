...
class CTCMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CTCMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CTCMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CTCMemDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CTCMemDC

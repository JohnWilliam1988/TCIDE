...
BEGIN_MESSAGE_MAP(CTCOddButton, CButton)
	//{{AFX_MSG_MAP(CTCOddButton)
	ON_WM_GETDLGCODE()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CTCOddButton message handlers

/*!
	PreSubclassWindow virtual override

  	Initialize internal data members and verify that the BS_OWNERDRAW style is set
	\note CTCOddButton::PreSubclassWindow should be called if overrided in a derived class
*/
void CTCOddButton::PreSubclassWindow() 
{
...
UINT CTCOddButton::OnGetDlgCode() 
{
...
LRESULT CTCOddButton::OnSetStyle(WPARAM wParam, LPARAM lParam)
{
...
/////////////////////////////////////////////////////////////////////////////
// CTCOddButton methods

/*!
	Get the type of control to draw
	\return The of control
*/
UINT CTCOddButton::GetControlType() const
{
	return m_nTypeStyle;
}
...
*/
BOOL CTCOddButton::IsDefault() const
{
...
*/
void CTCOddButton::EnableDefault(BOOL bEnable)
{
...
*/
void CTCOddButton::SetDefID(CDialog* pDialog, const UINT nID)
{

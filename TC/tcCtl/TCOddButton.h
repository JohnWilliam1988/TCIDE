...
/*!
	...
	CTCOddButton::IsDefault method to determine the default state and using 
	any visual effect (e.g. a thin black frame around the button) when it becomes default.

	\note A special static method CTCOddButton::SetDefID can be used to set the default button 
...
*/
class CTCOddButton : public CButton
{
// Construction
public:
	CTCOddButton();
...
// Implementation
public:
	virtual ~CTCOddButton();

// Generated message map functions
protected:
	//{{AFX_MSG(CTCOddButton)

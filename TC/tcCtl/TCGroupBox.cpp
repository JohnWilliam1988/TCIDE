...
IMPLEMENT_DYNAMIC(CTCGroupBox,CButton);
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::CTCGroupBox
//
...
CTCGroupBox::CTCGroupBox()
{
	...
	m_fontFaceName = _T("MS Sans Serif");
...
BEGIN_MESSAGE_MAP(CTCGroupBox, CButton)
	//{{AFX_MSG_MAP(CTCGroupBox)
	ON_WM_PAINT()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
BOOL CTCGroupBox::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::PreCreateWindow
//
// Description:		Modify the groupbox windows style 
//
// Name                     Date        Version Comments
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
BOOL CTCGroupBox::PreCreateWindow(CREATESTRUCT& cs) 
{
	// TODO: Add your specialized code here and/or call the base class
	cs.style |= BS_ICON;
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::PreSubclassWindow
//
// Description:		Modify the groupbox windows style 
//
//
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::ReconstructFont
//
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
void CTCGroupBox::ReconstructFont()
{
	m_font.DeleteObject();
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
void CTCGroupBox::UpdateSurface()
{
	CRect (rc);
	GetWindowRect(rc);
	RedrawWindow();
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::SetXPGroupStyle
//
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
CTCGroupBox& CTCGroupBox::SetTCGroupStyle(TCGroupBoxStyle eStyle) 
{
   m_nType = eStyle;
   UpdateSurface();
   return *this;
...
void CTCGroupBox::SetFontFaceName(CString str)
{
	m_fontFaceName = str;
}


void CTCGroupBox::GetFontFaceName(CString &str)
{
	str = m_fontFaceName;
}
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::SetBorderColor
//
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
CTCGroupBox& CTCGroupBox::SetBorderColor(COLORREF clrBorder)
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::SetCatptionTextColor
//
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
CTCGroupBox& CTCGroupBox::SetCatptionTextColor(COLORREF clrText ) 
{
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
CTCGroupBox& CTCGroupBox::SetBackgroundColor(COLORREF clrBKClient)
{
...
CTCGroupBox& CTCGroupBox::SetClientBackgroundColor(COLORREF clrBKClient)
{
	m_clrClientBackground = clrBKClient;
	UpdateSurface();
	return *this;
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
CTCGroupBox& CTCGroupBox::SetText(LPCTSTR lpszText)
{
...
void CTCGroupBox::GetText(CString &str)
{
	str = m_strTitle;
}

COLORREF	CTCGroupBox::GetBorderColor()const
{
    return m_clrBorder;
}
COLORREF	CTCGroupBox::GetTitleBackgroundColor()const
{
    return m_clrTitleBackground;
}
COLORREF	CTCGroupBox::GetClientBackgroundColor()const
{
    return m_clrClientBackground;
}

COLORREF	CTCGroupBox::GetTitleTextColor()const
{
    return m_clrTitleText;
}

CTCGroupBox::TCGroupBoxStyle CTCGroupBox::GetGroupBoxStyle() const
{
    return m_nType;
}

DWORD CTCGroupBox::GetAlignment() const
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CTCGroupBox::SetAlignment
//
...
// Jack Jin					2003-12-03    1.0     Origin
//////////////////////////////////////////////////////////////////////////
CTCGroupBox& CTCGroupBox::SetAlignment(DWORD dwType)
{
	switch(dwType)
	{

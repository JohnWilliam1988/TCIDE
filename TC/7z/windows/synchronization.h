...
class CSemaphore7z
{
  ::CSemaphore7z _object;
public:
  CSemaphore7z() { Semaphore_Construct(&_object); }
  ~CSemaphore7z() { Close(); }
...
class CCriticalSection7z
{
  ::CCriticalSection7z _object;
public:
  CCriticalSection7z() { CriticalSection_Init(&_object); }
  ~CCriticalSection7z() { CriticalSection_Delete(&_object); }
...
public:
  CCriticalSectionLock(CCriticalSection7z &object): _object(&object) {_object->Enter(); }

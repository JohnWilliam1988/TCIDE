...
#include <match/sax2/ContentHandler.hpp>
#include <match/sax2/LexicalHandler.hpp>
#include <match/sax2/DeclHandler.hpp>
#include <match/sax2/XMLReaderFactory.hpp>
#include <match/sax/DTDHandler.hpp>
#include <match/sax/ErrorHandler.hpp>
#include <match/sax/EntityResolver.hpp>
#include <match/sax/SAXParseException.hpp>
#include <match/sax/SAXException.hpp>
#include <match/internal/XMLScannerResolver.hpp>
#include <match/parsers/SAX2XMLReaderImpl.hpp>
...
void SAX2XMLReaderImpl::setFeature(const XMLCh* const name, const bool value)
{
    ...
    else if (XMLString::compareIStringASCII(name, XMLUni::fgMatchDynamic) == 0)
    {
...
void SAX2XMLReaderImpl::setProperty(const XMLCh* const name, void* value)
{
    ...
    if (XMLString::compareIStringASCII(name, XMLUni::fgMatchSchemaExternalSchemaLocation) == 0)
    {
    ...
    else if (XMLString::equals(name, XMLUni::fgMatchScannerName))
    {

...
#if !defined(MATCHC_INCLUDE_GUARD_ABSTRACTDOMPARSER_HPP)
#define MATCHC_INCLUDE_GUARD_ABSTRACTDOMPARSER_HPP
...
/**
  ...
  * It is used as a base for DOM parsers (i.e. MatchDOMParser, DOMLSParser).
  */

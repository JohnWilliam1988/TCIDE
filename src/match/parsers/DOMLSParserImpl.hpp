...
#if !defined(MATCHC_INCLUDE_GUARD_DOMBUILDERIMPL_HPP)
#define MATCHC_INCLUDE_GUARD_DOMBUILDERIMPL_HPP
...
private :
    ...
    //
    //  fXMLEntityResolver
    //      The installed Match entity resolver, if any. Null if none.
    //
    //  fErrorHandler

...
#if !defined(MATCHC_INCLUDE_GUARD_SAX2XMLFILTERIMPL_HPP)
#define MATCHC_INCLUDE_GUARD_SAX2XMLFILTERIMPL_HPP

#include <match/sax2/SAX2XMLFilter.hpp>
...
public :
  ...
  /**
	...
	*
	* <p>Note: Match (specifically) never skips any entities, regardless
	* of the above features.  This function is never called in the
	* Match implementation of SAX2.</p>
    *

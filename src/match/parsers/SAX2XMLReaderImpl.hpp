...
#if !defined(MATCHC_INCLUDE_GUARD_SAX2XMLREADERIMPL_HPP)
#define MATCHC_INCLUDE_GUARD_SAX2XMLREADERIMPL_HPP

#include <match/parsers/SAXParser.hpp>
#include <match/sax/Parser.hpp>
#include <match/framework/XMLBuffer.hpp>
#include <match/internal/VecAttributesImpl.hpp>
#include <match/sax2/SAX2XMLReader.hpp>
#include <match/util/RefStackOf.hpp>
#include <match/util/SecurityManager.hpp>
#include <match/util/ValueStackOf.hpp>
...
public :
  ...
  /**
    ...
    * Supported features in SAX2 for match-c are:
  ...
  /**
    ...
    * Supported properties in SAX2 for match-c are:
    * <br>(See the SAX2 Programming Guide for detail description).
    *
  ...
  /**
    ...
    */
    ...
    //  Getter Methods
    // -----------------------------------------------------------------------
    /** @name Getter Methods (Match-C specific) */
    //@{
    /**
    ...
    //  Setter Methods
    // -----------------------------------------------------------------------
    /** @name Setter Methods (Match-C specific) */
    //@{
    /**
    ...
    /**
      ...
      * Match-C extensions. There is no specification for this interface.</p>
      *

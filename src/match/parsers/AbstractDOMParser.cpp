...
//  Includes
// ---------------------------------------------------------------------------
#include <match/parsers/AbstractDOMParser.hpp>
#include <match/internal/XMLScannerResolver.hpp>
#include <match/internal/ElemStack.hpp>
#include <match/util/XMLUniDefs.hpp>
#include <match/framework/XMLNotationDecl.hpp>
#include <match/framework/XMLValidator.hpp>
#include <match/framework/psvi/PSVIElement.hpp>
#include <match/framework/psvi/PSVIAttribute.hpp>
#include <match/framework/psvi/PSVIAttributeList.hpp>
#include <match/framework/psvi/XSElementDeclaration.hpp>
...
#include <match/dom/impl/DOMAttrImpl.hpp>
#include <match/dom/impl/DOMAttrNSImpl.hpp>
#include <match/dom/impl/DOMTypeInfoImpl.hpp>
#include <match/dom/impl/DOMCDATASectionImpl.hpp>
#include <match/dom/DOMComment.hpp>
#include <match/dom/impl/DOMTextImpl.hpp>
#include <match/dom/impl/DOMDocumentImpl.hpp>
#include <match/dom/impl/DOMDocumentTypeImpl.hpp>
#include <match/dom/DOMDocumentType.hpp>
#include <match/dom/impl/DOMElementNSImpl.hpp>
#include <match/dom/impl/DOMEntityImpl.hpp>
#include <match/dom/impl/DOMEntityReferenceImpl.hpp>
#include <match/dom/impl/DOMNotationImpl.hpp>
#include <match/dom/DOMNamedNodeMap.hpp>
#include <match/dom/DOMProcessingInstruction.hpp>
#include <match/dom/impl/DOMProcessingInstructionImpl.hpp>
#include <match/dom/impl/DOMNodeIDMap.hpp>
#include <match/dom/impl/DOMCasts.hpp>
...
#include <match/xinclude/XIncludeUtils.hpp>
                                            ...
                                            ,       PSVIAttributeList *     psviAttributes)
{
    if(fCreateSchemaInfo)
    {
        for (XMLSize_t index=0; index < psviAttributes->getLength(); index++) {
            MATCH_CPP_NAMESPACE_QUALIFIER PSVIAttribute *attrInfo=psviAttributes->getAttributePSVIAtIndex(index);
            MATCH_CPP_NAMESPACE_QUALIFIER DOMNode* pAttrNode=fCurrentNode->getAttributes()->getNamedItemNS(psviAttributes->getAttributeNamespaceAtIndex(index),

...
/*
 * $Id: MatchDOMParser.hpp 932887 2010-04-11 13:04:59Z borisk $
 */

#if !defined(MATCHC_INCLUDE_GUARD_MATCHDOMPARSER_HPP)
#define MATCHC_INCLUDE_GUARD_MATCHDOMPARSER_HPP
...
class XMLResourceIdentifier;
  ...
  */
class PARSERS_EXPORT MatchDOMParser : public AbstractDOMParser
{
public :
    // -----------------------------------------------------------------------
    ...
    //@{
    /** Construct a MatchDOMParser, with an optional validator
      *
...
private :
    ...
    // -----------------------------------------------------------------------
    MatchDOMParser(const MatchDOMParser&);
    MatchDOMParser& operator=(const MatchDOMParser&);
...
// ---------------------------------------------------------------------------
//  MatchDOMParser: Handlers for the XMLEntityHandler interface
// ---------------------------------------------------------------------------
inline void MatchDOMParser::endInputSource(const InputSource&)
{
    // The DOM entity resolver doesn't handle this
}

inline bool MatchDOMParser::expandSystemId(const XMLCh* const, XMLBuffer&)
{
    // The DOM entity resolver doesn't handle this
    return false;
}

inline void MatchDOMParser::resetEntities()
{
    // Nothing to do on this one
}

inline void MatchDOMParser::startInputSource(const InputSource&)
{
    // The DOM entity resolver doesn't handle this
}
...
// ---------------------------------------------------------------------------
inline ErrorHandler* MatchDOMParser::getErrorHandler()
{
    return fErrorHandler;
}

inline const ErrorHandler* MatchDOMParser::getErrorHandler() const
{
    return fErrorHandler;
}

inline EntityResolver* MatchDOMParser::getEntityResolver()
{
    return fEntityResolver;
}

inline const EntityResolver* MatchDOMParser::getEntityResolver() const
{
    return fEntityResolver;
}

inline XMLEntityResolver* MatchDOMParser::getXMLEntityResolver()
{
    return fXMLEntityResolver;
}

inline const XMLEntityResolver* MatchDOMParser::getXMLEntityResolver() const
{
    return fXMLEntityResolver;
}

...
#if !defined(MATCHC_INCLUDE_GUARD_TRANSSERVICE_HPP)
#define MATCHC_INCLUDE_GUARD_TRANSSERVICE_HPP
...
//  transcoding services that Match uses. The parser's actual transcoding

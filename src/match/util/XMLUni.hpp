...
#if !defined(MATCHC_INCLUDE_GUARD_XMLUNI_HPP)
#define MATCHC_INCLUDE_GUARD_XMLUNI_HPP
...
public :
    ...
    // Match features/properties names
    static const XMLCh fgMatchDynamic[];
    static const XMLCh fgMatchSchema[];
    static const XMLCh fgMatchSchemaFullChecking[];
    static const XMLCh fgMatchLoadSchema[];
    static const XMLCh fgMatchIdentityConstraintChecking[];
    static const XMLCh fgMatchSchemaExternalSchemaLocation[];
    static const XMLCh fgMatchSchemaExternalNoNameSpaceSchemaLocation[];
    static const XMLCh fgMatchSecurityManager[];
    static const XMLCh fgMatchLoadExternalDTD[];
    static const XMLCh fgMatchContinueAfterFatalError[];
    static const XMLCh fgMatchValidationErrorAsFatal[];
    static const XMLCh fgMatchUserAdoptsDOMDocument[];
    static const XMLCh fgMatchCacheGrammarFromParse[];
    static const XMLCh fgMatchUseCachedGrammarInParse[];
    static const XMLCh fgMatchScannerName[];
    static const XMLCh fgMatchParserUseDocumentFromImplementation[];
    static const XMLCh fgMatchCalculateSrcOfs[];
    static const XMLCh fgMatchStandardUriConformant[];
    static const XMLCh fgMatchDOMHasPSVIInfo[];
    static const XMLCh fgMatchGenerateSyntheticAnnotations[];
    static const XMLCh fgMatchValidateAnnotations[];
    static const XMLCh fgMatchIgnoreCachedDTD[];
    static const XMLCh fgMatchIgnoreAnnotations[];
    static const XMLCh fgMatchDisableDefaultEntityResolution[];
    static const XMLCh fgMatchSkipDTDValidation[];
    static const XMLCh fgMatchEntityResolver[];
    static const XMLCh fgMatchHandleMultipleImports[];
    static const XMLCh fgMatchDoXInclude[];
    static const XMLCh fgMatchLowWaterMark[];
    ...
    static const XMLCh fgDOMWRTMatchPrettyPrint[];

    // Private interface names
    static const XMLCh fgMatchcInterfacePSVITypeInfo[];
    static const XMLCh fgMatchcInterfaceDOMDocumentTypeImpl[];
    static const XMLCh fgMatchcInterfaceDOMDocumentImpl[];
    static const XMLCh fgMatchcInterfaceDOMMemoryManager[];

    // Locale
    static const char  fgMatchcDefaultLocale[];
...
////////////////////////////////////////////////////////自定义的异常//////////////////////////////
    //Pragram Grammar Exception
	static const XMLCh fgMyGrammarException_Name[];

	//效验的异常
	static const XMLCh fgMyValidException_Name[];
////////////////////////////////////////////////////////自定义的异常//////////////////////////////
private:
    // -----------------------------------------------------------------------

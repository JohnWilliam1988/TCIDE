...
#if !defined(MATCHC_INCLUDE_GUARD_XMEMORY_HPP)
#define MATCHC_INCLUDE_GUARD_XMEMORY_HPP
 ...
 *  allows applications to control Match memory management.
 */
...
#if defined(MATCH_NEED_XMEMORY_VIRTUAL_DESTRUCTOR)
    virtual ~XMemory()
    {
    }
#endif

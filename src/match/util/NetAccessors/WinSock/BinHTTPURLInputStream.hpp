...
#if !defined(MATCHC_INCLUDE_GUARD_BINHTTPURLINPUTSTREAM_HPP)
#define MATCHC_INCLUDE_GUARD_BINHTTPURLINPUTSTREAM_HPP


#include <match/util/NetAccessors/BinHTTPInputStreamCommon.hpp>

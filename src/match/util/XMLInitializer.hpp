...
#if !defined(MATCHC_INCLUDE_GUARD_XMLINITIALIZER_HPP)
#define MATCHC_INCLUDE_GUARD_XMLINITIALIZER_HPP
...
private:
    ...
    static void XMLInitializer::initializeMatchScanner();
    
    //match 自定义脚本扫描文件全局静态变量销毁方法
    static void XMLInitializer::terminateMatchScanner();

    //match 自定义脚本扫描文件全局静态变量初始化方法
    static void XMLInitializer::initializeMatchEventScanner();
    
    //match 自定义脚本扫描文件全局静态变量销毁方法
    static void XMLInitializer::terminateMatchEventScanner();

    //match 自定义数据抽象类的全局静态变量初始化方法
    //static void XMLInitializer::initializeMyValue();
  
    //match 自定义数据抽象类的全局静态变量销毁方法
    //static void XMLInitializer::terminateMyValue();

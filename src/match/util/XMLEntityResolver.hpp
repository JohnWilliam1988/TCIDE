...
#if !defined(MATCHC_INCLUDE_GUARD_XMLENTITYRESOLVER_HPP)
#define MATCHC_INCLUDE_GUARD_XMLENTITYRESOLVER_HPP
...
/**
  ...
  *
  *<code>
  * \#include <match/util/XMLEntityResolver.hpp><br>
  * \#include <match/sax/InputSource.hpp><br>
  *<br>

...
#if !defined(MATCHC_INCLUDE_GUARD_PANICHANDLER_HPP)
#define MATCHC_INCLUDE_GUARD_PANICHANDLER_HPP
...
/**
  ...
  *
  * <p>This is the interface, through which the Matchc reports
  *    a panic to the application. 
  * </p>
  *
  * <p>Application may implement this interface, instantiate an
  *    object of the derivative, and plug it to Matchc in the
  *    invocation to XMLPlatformUtils::Initialize(), if it prefers 
  *    to handling panic itself rather than Matchc doing it.
  * </p>
  *
  */
...
public:
    ...
    * Receive notification of panic
    *
    * This method is called when an unrecoverable error has occurred in the Match library.  
    *
    ...
    *
    * Once this method has been called, the results of calling any other Match API, 
    * or using any existing Match objects are undefined.    
    *

...
#if !defined(MATCHC_INCLUDE_GUARD_ABSTRACTVECTOROF_HPP)
#define MATCHC_INCLUDE_GUARD_ABSTRACTVECTOROF_HPP
...
/** 
 * Abstract base class for the match internal representation of Vector. 
 * 
...
#include <match/util/BaseRefVectorOf.c>
#endif

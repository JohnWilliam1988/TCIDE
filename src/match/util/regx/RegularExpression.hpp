...
#if !defined(MATCHC_INCLUDE_GUARD_REGULAREXPRESSION_HPP)
#define MATCHC_INCLUDE_GUARD_REGULAREXPRESSION_HPP
...
#include <match/util/regx/Op.hpp>
#include <match/util/regx/TokenFactory.hpp>
#include <match/util/regx/BMPattern.hpp>
#include <match/util/regx/OpFactory.hpp>
#include <match/util/regx/RegxUtil.hpp>

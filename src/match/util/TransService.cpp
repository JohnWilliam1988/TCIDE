...
#include <match/util/XML88591Transcoder.hpp>
#include <match/util/XMLASCIITranscoder.hpp>
#include <match/util/XMLChTranscoder.hpp>
#include <match/util/XMLEBCDICTranscoder.hpp>
#include <match/util/XMLIBM1047Transcoder.hpp>
#include <match/util/XMLIBM1140Transcoder.hpp>
#include <match/util/XMLUCS4Transcoder.hpp>
#include <match/util/XMLUTF8Transcoder.hpp>
#include <match/util/XMLUTF16Transcoder.hpp>
#include <match/util/XMLWin1252Transcoder.hpp>
#include <match/util/XMLUniDefs.hpp>
#include <match/util/XMLUni.hpp>
#include <match/util/EncodingValidator.hpp>
#include <match/util/PlatformUtils.hpp>
#include <match/util/TransENameMap.hpp>
...
void XMLTransService::initTransService()
{
    ...
    //
    gMappingsRecognizer->setElementAt(new ENameMapFor<XMLChTranscoder>(XMLUni::fgXMLChEncodingString), XMLRecognizer::MATCH_XMLCH);

...
#if !defined(MATCHC_INCLUDE_GUARD_XMLIBM1140TRANSCODER_HPP)
#define MATCHC_INCLUDE_GUARD_XMLIBM1140TRANSCODER_HPP

#include <match/util/MatchDefs.hpp>
#include <match/util/XML256TableTranscoder.hpp>

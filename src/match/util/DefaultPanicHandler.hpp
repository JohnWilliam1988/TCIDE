...
#if !defined(MATCHC_INCLUDE_GUARD_DEFAULT_PANICHANDLER_HPP)
#define MATCHC_INCLUDE_GUARD_DEFAULT_PANICHANDLER_HPP
...
/**
  ...
  *
  * <p>This is Match' default implementation of the PanicHanlder 

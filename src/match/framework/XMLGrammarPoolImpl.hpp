...
#if !defined(MATCHC_INCLUDE_GUARD_XMLGRAMMARPOOLIMPL_HPP)
#define MATCHC_INCLUDE_GUARD_XMLGRAMMARPOOLIMPL_HPP
...
public :
    ...
    /***
      ...
      * Versioning
      *
      *    Only binary data serialized with the current MatchC Version and

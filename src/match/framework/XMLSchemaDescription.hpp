...
#if !defined(MATCHC_INCLUDE_GUARD_XMLSCHEMADESCRIPTION_HPP)
#define MATCHC_INCLUDE_GUARD_XMLSCHEMADESCRIPTION_HPP

#include <match/framework/XMLGrammarDescription.hpp>

...
#if !defined(MATCHC_INCLUDE_GUARD_MEMORYMANAGER_HPP)
#define MATCHC_INCLUDE_GUARD_MEMORYMANAGER_HPP
 ...
 *  manager to be used by Match for memory allocation/deallocation.</p>
 */

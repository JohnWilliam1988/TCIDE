...
//  Includes
// ---------------------------------------------------------------------------
#include <match/framework/XMLGrammarPoolImpl.hpp>
#include <match/internal/XSerializeEngine.hpp>
...
#include <match/util/SynchronizedStringPool.hpp>
...
void XMLGrammarPoolImpl::serializeGrammars(BinOutputStream* const binOut)
{
    ...
    //version information
    serEng<<(unsigned int)MATCH_GRAMMAR_SERIALIZATION_LEVEL;

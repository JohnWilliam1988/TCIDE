...
#if !defined(MATCHC_INCLUDE_GUARD_XSATTRIBUTEGROUPDEFINITION_HPP)
#define MATCHC_INCLUDE_GUARD_XSATTRIBUTEGROUPDEFINITION_HPP

#include <match/framework/psvi/XSObject.hpp>
...
protected:
    ...
    //  data members
    // -----------------------------------------------------------------------
    MatchAttGroupInfo*     fMatchAttGroupInfo;

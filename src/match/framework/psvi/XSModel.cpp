...
void XSModel::addGrammarToXSModel(XSNamespaceItem* namespaceItem)
{
    ...
    RefHashTableOf<MatchAttGroupInfo>* attGroupInfoRegistry = namespaceItem->fGrammar->getAttGroupInfoRegistry();
    if(attGroupInfoRegistry) {
        RefHashTableOfEnumerator<MatchAttGroupInfo> attrGroupEnum = RefHashTableOfEnumerator<MatchAttGroupInfo> (attGroupInfoRegistry, false, fMemoryManager);
    ...
    RefHashTableOf<MatchGroupInfo>* groupInfoRegistry = namespaceItem->fGrammar->getGroupInfoRegistry();
    if(groupInfoRegistry) {
        RefHashTableOfEnumerator<MatchGroupInfo> modelGroupEnum = RefHashTableOfEnumerator<MatchGroupInfo> (groupInfoRegistry, false, fMemoryManager);
    ...
    // or store them in the MatchToXSMap.

...
#if !defined(MATCHC_INCLUDE_GUARD_XSELEMENTDECLARATION_HPP)
#define MATCHC_INCLUDE_GUARD_XSELEMENTDECLARATION_HPP

#include <match/framework/psvi/XSObject.hpp>
#include <match/framework/psvi/XSNamedMap.hpp>

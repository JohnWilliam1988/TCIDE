...
#if !defined(MATCHC_INCLUDE_GUARD_XSVALUE_HPP)
#define MATCHC_INCLUDE_GUARD_XSVALUE_HPP
...
public:
    ...
    enum DataType {
              ...
              /*dt_MAXCOUNT             = 44*/
			  dt_MAXCOUNT             = 64        //match改动,为了和Myvalue的数据类型完全一致,把dt_MAXCOUNT改成64,应该是没有任何影响的
    };
...
private:
	...
	//TC自定义-match-为了访问更方便,简化了MyValue的实现-2011-11-8

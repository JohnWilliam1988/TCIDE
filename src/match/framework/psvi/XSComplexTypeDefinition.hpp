...
#if !defined(MATCHC_INCLUDE_GUARD_XSCOMPLEXTYPEDEFINITION_HPP)
#define MATCHC_INCLUDE_GUARD_XSCOMPLEXTYPEDEFINITION_HPP

#include <match/framework/psvi/XSTypeDefinition.hpp>

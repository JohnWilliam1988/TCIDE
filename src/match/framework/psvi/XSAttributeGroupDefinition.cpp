...
(
    MatchAttGroupInfo* const   matchAttGroupInfo
    ...
    , fMatchAttGroupInfo(matchAttGroupInfo)
...
{
    return fXSModel->getURIStringPool()->getValueForId(fMatchAttGroupInfo->getNameId());        
}

const XMLCh *XSAttributeGroupDefinition::getNamespace() 
{
    return fXSModel->getURIStringPool()->getValueForId(fMatchAttGroupInfo->getNamespaceId());
}

#if !defined(MYSELECTPARSER_H)
#define MYSELECTPARSER_H
...
class PARSERS_EXPORT MySelectParser  : public AbsBlockParser
{
public:
	//构造函数
    //参数说明:
	...
	MySelectParser(const XMLCh *nameSpace
...
private:
	...
	//CCF 拷贝构造函数
	MySelectParser(const MySelectParser& pool);
	MySelectParser& operator=(const MySelectParser& toAssign);
};

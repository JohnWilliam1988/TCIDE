...
//  Includes
// ---------------------------------------------------------------------------
#include <match/internal/IGXMLScanner.hpp>
#include <match/internal/EndOfEntityException.hpp>
#include <match/util/UnexpectedEOFException.hpp>
#include <match/util/XMLUri.hpp>
#include <match/framework/LocalFileInputSource.hpp>
#include <match/framework/URLInputSource.hpp>
#include <match/framework/XMLDocumentHandler.hpp>
#include <match/framework/XMLEntityHandler.hpp>
#include <match/framework/XMLPScanToken.hpp>
...
#include <match/validators/common/ContentLeafNameTypeVector.hpp>
#include <match/validators/DTD/DTDGrammar.hpp>
#include <match/validators/DTD/DTDValidator.hpp>
#include <match/validators/DTD/XMLDTDDescriptionImpl.hpp>
#include <match/validators/datatype/DatatypeValidator.hpp>
#include <match/validators/schema/XMLSchemaDescriptionImpl.hpp>
#include <match/validators/schema/SchemaGrammar.hpp>
#include <match/validators/schema/SchemaValidator.hpp>
...
#include <match/validators/schema/identity/IdentityConstraintHandler.hpp>
#include <match/validators/schema/identity/ValueStore.hpp>
...
void IGXMLScanner::resolveSchemaGrammar(const XMLCh* const loc, const XMLCh* const uri, bool ignoreLoadSchema) {
         ...
         getContextType () == XMLSchemaDescription::CONTEXT_IMPORT))
    {
      if (fLoadSchema || ignoreLoadSchema)
      {
        ...
        parser.setValidationScheme(MatchDOMParser::Val_Never);

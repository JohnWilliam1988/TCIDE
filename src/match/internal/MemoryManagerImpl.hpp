...
#if !defined(MATCHC_INCLUDE_GUARD_MEMORYMANAGERIMPL_HPP)
#define MATCHC_INCLUDE_GUARD_MEMORYMANAGERIMPL_HPP
...
/**
  ...
  *
  * <p>This is Match default implementation of the memory

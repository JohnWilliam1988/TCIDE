...
#if !defined(MATCHC_INCLUDE_GUARD_BINFILEOUTPUTSTREAM_HPP)
#define MATCHC_INCLUDE_GUARD_BINFILEOUTPUTSTREAM_HPP

#include <match/framework/BinOutputStream.hpp>
...
{
    return (fSource != (FileHandle) MATCH_Invalid_File_Handle);
}

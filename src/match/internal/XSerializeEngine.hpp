...
#if !defined(MATCHC_INCLUDE_GUARD_XSERIALIZE_ENGINE_HPP)
#define MATCHC_INCLUDE_GUARD_XSERIALIZE_ENGINE_HPP

#include <match/util/RefHashTableOf.hpp>
#include <match/util/ValueVectorOf.hpp>
#include <match/util/XMLExceptMsgs.hpp>

#include <match/internal/XSerializationException.hpp>

...
#if !defined(MATCHC_INCLUDE_GUARD_NAMESPACESCOPE_HPP)
#define MATCHC_INCLUDE_GUARD_NAMESPACESCOPE_HPP

#include <match/util/StringPool.hpp>

MATCH_CPP_NAMESPACE_BEGIN

// Define a pure interface to allow MatchXPath to work on both NamespaceScope and DOMXPathNSResolver
class VALIDATORS_EXPORT MatchNamespaceResolver
{
public:

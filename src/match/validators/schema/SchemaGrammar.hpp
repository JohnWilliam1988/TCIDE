...
#if !defined(MATCHC_INCLUDE_GUARD_SCHEMAGRAMMAR_HPP)
#define MATCHC_INCLUDE_GUARD_SCHEMAGRAMMAR_HPP
...
#include <match/framework/ValidationContext.hpp>
...
public:
    ...
    RefHashTableOf<MatchGroupInfo>* getGroupInfoRegistry() const;
    RefHashTableOf<MatchAttGroupInfo>* getAttGroupInfoRegistry() const;
    ...
    void setGroupInfoRegistry(RefHashTableOf<MatchGroupInfo>* const other);
    void setAttGroupInfoRegistry(RefHashTableOf<MatchAttGroupInfo>* const other);
...
private:
    ...
    RefHashTableOf<MatchGroupInfo>*         fGroupInfoRegistry;
    RefHashTableOf<MatchAttGroupInfo>*      fAttGroupInfoRegistry;
...
inline RefHashTableOf<MatchGroupInfo>*
SchemaGrammar::getGroupInfoRegistry() const {

    return fGroupInfoRegistry;
}

inline RefHashTableOf<MatchAttGroupInfo>*
...
inline void
SchemaGrammar::setGroupInfoRegistry(RefHashTableOf<MatchGroupInfo>* const other) {

    fGroupInfoRegistry = other;
}

inline void
SchemaGrammar::setAttGroupInfoRegistry(RefHashTableOf<MatchAttGroupInfo>* const other) {

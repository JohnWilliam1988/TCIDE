...
/*
 * $Id: MatchAttGroupInfo.cpp 676911 2008-07-15 13:27:32Z amassari $
 */
...
// ---------------------------------------------------------------------------
//  MatchAttGroupInfo: Constructors and Destructor
// ---------------------------------------------------------------------------
MatchAttGroupInfo::MatchAttGroupInfo(MemoryManager* const manager)
    : fTypeWithId(false)
    , fNameId(0)
    , fNamespaceId(0)
    , fAttributes(0)
...
MatchAttGroupInfo::MatchAttGroupInfo(unsigned int attGroupNameId,
...
MatchAttGroupInfo::~MatchAttGroupInfo()
{
    delete fAttributes;
...
bool MatchAttGroupInfo::containsAttribute(const XMLCh* const name,
...
// ---------------------------------------------------------------------------
const SchemaAttDef* MatchAttGroupInfo::getAttDef(const XMLCh* const baseName,
...
IMPL_XSERIALIZABLE_TOCREATE(MatchAttGroupInfo)

void MatchAttGroupInfo::serialize(XSerializeEngine& serEng)
{
...
/**
  * End of file MatchAttGroupInfo.cpp
  */

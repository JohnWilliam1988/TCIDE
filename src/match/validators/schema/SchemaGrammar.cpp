...
void SchemaGrammar::serialize(XSerializeEngine& serEng)
{
    ...
    if (serEng.isStoring())
    {
        ...
        ***/
         ...
         * Serialize RefHashTableOf<MatchGroupInfo>*       fGroupInfoRegistry;
         * Serialize RefHashTableOf<MatchAttGroupInfo>*    fAttGroupInfoRegistry;
    ...
    else
    {
        ...
        ***/
         ...
         * Deserialize RefHashTableOf<MatchGroupInfo>*       fGroupInfoRegistry;
         * Deserialize RefHashTableOf<MatchAttGroupInfo>*    fAttGroupInfoRegistry;

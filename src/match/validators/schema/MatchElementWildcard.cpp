...
/*
 * $Id: MatchElementWildcard.cpp 671133 2008-06-24 11:22:29Z borisk $
 */
...
/**
 * MatchElementWildcard is used to check whether two element declarations conflict
 */
/**
 * Check whether two element declarations conflict
 */
bool MatchElementWildcard::conflict(SchemaGrammar* const pGrammar,
...
bool MatchElementWildcard::uriInWildcard(SchemaGrammar* const         pGrammar,
                                          QName*                       qname,
...
bool MatchElementWildcard::wildcardIntersect(ContentSpecNode::NodeTypes t1,
                                              unsigned int               w1,

...
#if !defined(MATCHC_INCLUDE_GUARD_IC_FIELD_HPP)
#define MATCHC_INCLUDE_GUARD_IC_FIELD_HPP
...
public:
    ...
    // -----------------------------------------------------------------------
    IC_Field(MatchXPath* const xpath,
...
private:
    ...
    //  Constructors/Destructor
    // -----------------------------------------------------------------------
    FieldMatcher(MatchXPath* const anXPath,

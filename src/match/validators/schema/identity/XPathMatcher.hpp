...
#if !defined(MATCHC_INCLUDE_GUARD_XPATHMATCHER_HPP)
#define MATCHC_INCLUDE_GUARD_XPATHMATCHER_HPP
...
public:
    ...
    // -----------------------------------------------------------------------
    XPathMatcher(MatchXPath* const xpath,
...
protected:
    ...
    bool matches(const MatchNodeTest* nodeTest, const QName* qName);
...
private:
    ...
    //  Helper methods
    // -----------------------------------------------------------------------
    void init(MatchXPath* const xpath);
    void cleanUp();

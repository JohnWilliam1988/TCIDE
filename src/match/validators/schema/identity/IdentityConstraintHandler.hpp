...
#if !defined(MATCHC_INCLUDE_GUARD_IDENTITYCONSTRAINT_HANDLER_HPP)
#define MATCHC_INCLUDE_GUARD_IDENTITYCONSTRAINT_HANDLER_HPP

// ---------------------------------------------------------------------------
//  Includes
// ---------------------------------------------------------------------------
#include <match/validators/schema/identity/ValueStoreCache.hpp>
#include <match/validators/schema/identity/XPathMatcherStack.hpp>

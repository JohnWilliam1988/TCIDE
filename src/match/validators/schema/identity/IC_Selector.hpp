...
#if !defined(MATCHC_INCLUDE_GUARD_IC_SELECTOR_HPP)
#define MATCHC_INCLUDE_GUARD_IC_SELECTOR_HPP
...
public:
    ...
    // -----------------------------------------------------------------------
    IC_Selector(MatchXPath* const xpath,
    ...
    //  Getter methods
    // -----------------------------------------------------------------------
    MatchXPath* getXPath() const { return fXPath; }
...
private:
    ...
    //  Constructors/Destructor
    // -----------------------------------------------------------------------
    SelectorMatcher(MatchXPath* const anXPath,

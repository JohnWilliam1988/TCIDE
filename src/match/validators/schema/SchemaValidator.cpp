                                           ...
                                           bool validateDefAttr)
{
    ...
    while (grammarEnum.hasMoreElements())
    {
        ...
        if (getScanner()->getValidationSchemaFullChecking()) {
            ...
            RefHashTableOf<MatchGroupInfo>* groupInfoRegistry = sGrammar.getGroupInfoRegistry();
            RefHashTableOfEnumerator<MatchGroupInfo> groupEnum(groupInfoRegistry, false, fMemoryManager);

            while (groupEnum.hasMoreElements()) {

                MatchGroupInfo& curGroup = groupEnum.nextElement();
                MatchGroupInfo* baseGroup = curGroup.getBaseGroup();
...
void SchemaValidator::checkRefElementConsistency(SchemaGrammar* const currentGrammar,
                                                 ...
                                                 const MatchGroupInfo* const curGroup) {

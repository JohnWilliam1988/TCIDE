...
#include <match/framework/XMLElementDecl.hpp>
#include <match/framework/XMLValidator.hpp>
#include <match/validators/common/CMAny.hpp>
#include <match/validators/common/CMBinaryOp.hpp>
#include <match/validators/common/CMLeaf.hpp>
#include <match/validators/common/CMRepeatingLeaf.hpp>
#include <match/validators/common/CMUnaryOp.hpp>
#include <match/validators/common/DFAContentModel.hpp>
...
#include <match/validators/schema/MatchElementWildcard.hpp>
#include <match/util/RefHashTableOf.hpp>
#include <match/util/XMLInteger.hpp>
#include <math.h>
        ...
        for (j = 0; j < fElemMapSize; j++) {
            for (k = j+1; k < fElemMapSize; k++) {
                if (fTransTable[i][j] != XMLContentModel::gInvalidTrans &&
                    ...
                    if (MatchElementWildcard::conflict(pGrammar,
                                                        fElemMapType[j],
                                                        fElemMap[j],
                                                        fElemMapType[k],
                                                        fElemMap[k],

...
#if !defined(MATCHC_INCLUDE_GUARD_DATATYPEVALIDATOR_HPP)
#define MATCHC_INCLUDE_GUARD_DATATYPEVALIDATOR_HPP

#include <match/util/PlatformUtils.hpp>
#include <match/util/RefHashTableOf.hpp>
#include <match/util/KVStringPair.hpp>
...
public:
     ...
     * due to the internals of match this will set the uri to be the schema uri if

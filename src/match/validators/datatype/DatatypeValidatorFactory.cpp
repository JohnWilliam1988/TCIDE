...
//  Includes
// ---------------------------------------------------------------------------
#include <match/validators/datatype/DatatypeValidatorFactory.hpp>
#include <match/validators/schema/SchemaSymbols.hpp>
#include <match/util/XMLUniDefs.hpp>
#include <match/util/Janitor.hpp>
#include <match/validators/datatype/StringDatatypeValidator.hpp>
#include <match/validators/datatype/BooleanDatatypeValidator.hpp>
#include <match/validators/datatype/DecimalDatatypeValidator.hpp>
#include <match/validators/datatype/HexBinaryDatatypeValidator.hpp>
#include <match/validators/datatype/Base64BinaryDatatypeValidator.hpp>
#include <match/validators/datatype/IDDatatypeValidator.hpp>
#include <match/validators/datatype/IDREFDatatypeValidator.hpp>
#include <match/validators/datatype/NOTATIONDatatypeValidator.hpp>
#include <match/validators/datatype/ENTITYDatatypeValidator.hpp>
#include <match/validators/datatype/QNameDatatypeValidator.hpp>
#include <match/validators/datatype/NameDatatypeValidator.hpp>
#include <match/validators/datatype/NCNameDatatypeValidator.hpp>
#include <match/validators/datatype/ListDatatypeValidator.hpp>
#include <match/validators/datatype/UnionDatatypeValidator.hpp>
#include <match/validators/datatype/DoubleDatatypeValidator.hpp>
#include <match/validators/datatype/FloatDatatypeValidator.hpp>
#include <match/validators/datatype/AnyURIDatatypeValidator.hpp>
#include <match/validators/datatype/AnySimpleTypeDatatypeValidator.hpp>
#include <match/validators/datatype/DateTimeDatatypeValidator.hpp>
#include <match/validators/datatype/DateDatatypeValidator.hpp>
#include <match/validators/datatype/TimeDatatypeValidator.hpp>
#include <match/validators/datatype/DayDatatypeValidator.hpp>
#include <match/validators/datatype/MonthDatatypeValidator.hpp>
#include <match/validators/datatype/MonthDayDatatypeValidator.hpp>
#include <match/validators/datatype/YearDatatypeValidator.hpp>
#include <match/validators/datatype/YearMonthDatatypeValidator.hpp>
#include <match/validators/datatype/DurationDatatypeValidator.hpp>

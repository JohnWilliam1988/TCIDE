...
#if !defined(MATCHC_INCLUDE_GUARD_DATATYPEVALIDATORFACTORY_HPP)
#define MATCHC_INCLUDE_GUARD_DATATYPEVALIDATORFACTORY_HPP
...
#include <match/validators/datatype/XMLCanRepGroup.hpp>
...
private:
    ...
    // -----------------------------------------------------------------------
    MATCH_CPP_NAMESPACE_QUALIFIER RefHashTableOf<MATCH_CPP_NAMESPACE_QUALIFIER DatatypeValidator>*        fUserDefinedRegistry;
    static MATCH_CPP_NAMESPACE_QUALIFIER RefHashTableOf<DatatypeValidator>* fBuiltInRegistry;
    static MATCH_CPP_NAMESPACE_QUALIFIER RefHashTableOf<XMLCanRepGroup, PtrHasher>*    fCanRepRegistry;
    MATCH_CPP_NAMESPACE_QUALIFIER MemoryManager* const fMemoryManager;

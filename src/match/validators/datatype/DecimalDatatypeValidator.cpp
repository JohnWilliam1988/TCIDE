...
#include <match/validators/datatype/InvalidDatatypeFacetException.hpp>
#include <match/validators/datatype/InvalidDatatypeValueException.hpp>

#include <match/validators/datatype/DatatypeValidatorFactory.hpp>
#include <match/util/NumberFormatException.hpp>
#include <match/util/XMLBigDecimal.hpp>
#include <match/util/XMLBigInteger.hpp>

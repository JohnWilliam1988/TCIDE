...
#if !defined(MATCHC_INCLUDE_GUARD_DOMLSPARSER_HPP)
#define MATCHC_INCLUDE_GUARD_DOMLSPARSER_HPP
...
public:
    ...
    /**
      ...
      *
      * In addition to these, Match adds these non standard parameters:
      *
    ...
    /**
      ...
      *                                            attribute is true.
      * @exception DOMLSException PARSE_ERR: Starting from Match-C++ 4.0.0 this exception is

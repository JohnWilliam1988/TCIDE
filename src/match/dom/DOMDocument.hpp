...
#if !defined(MATCHC_INCLUDE_GUARD_DOMDOCUMENT_HPP)
#define MATCHC_INCLUDE_GUARD_DOMDOCUMENT_HPP
...
public:
     ...
     * Used by internally XSDMatchDOMParser during schema traversal.
     *

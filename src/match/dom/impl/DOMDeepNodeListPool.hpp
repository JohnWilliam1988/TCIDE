...
#if !defined(MATCHC_INCLUDE_GUARD_DOMDEEPNODELISTPOOL_HPP)
#define MATCHC_INCLUDE_GUARD_DOMDEEPNODELISTPOOL_HPP


#include <match/util/Hashers.hpp>
...
#include <match/util/XMLEnumerator.hpp>
...
#if !defined(MATCH_TMPLSINC)
#include <match/dom/impl/DOMDeepNodeListPool.c>
#endif

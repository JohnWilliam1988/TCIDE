    ...
    case DOMNode::ELEMENT_NODE :
        {
            ...
            else
            {
                ...
                DOMPSVITypeInfo* sourcePSVI=(DOMPSVITypeInfo*)source->getFeature(XMLUni::fgMatchcInterfacePSVITypeInfo, 0);
    ...
    case DOMNode::DOCUMENT_TYPE_NODE :
        {
            ...
            try
            {
                DOMDocumentTypeImpl* docTypeImpl=(DOMDocumentTypeImpl*)(srcdoctype->getFeature(XMLUni::fgMatchcInterfaceDOMDocumentTypeImpl, XMLUni::fgZeroLenString));
                if(docTypeImpl)
                {
...
bool DOMDocumentImpl::isSupported(const XMLCh *feature, const XMLCh *version) const
{
    ...
    if(feature && *feature=='+' && XMLString::equals(feature+1, XMLUni::fgMatchcInterfaceDOMMemoryManager))
        return true;
    if(feature && *feature)
    {
        if((*feature==chPlus && XMLString::equals(feature+1, XMLUni::fgMatchcInterfaceDOMDocumentImpl)) ||
           XMLString::equals(feature, XMLUni::fgMatchcInterfaceDOMDocumentImpl))
            return true;
    }
...
{
    if(XMLString::equals(feature, XMLUni::fgMatchcInterfaceDOMMemoryManager))
        return (DOMMemoryManager*)this;
    if(XMLString::equals(feature, XMLUni::fgMatchcInterfaceDOMDocumentImpl))

...
#include <match/framework/MemBufFormatTarget.hpp>
#include <match/framework/LocalFileFormatTarget.hpp>
...
#include <match/dom/StDOMNode.hpp>
...
,fMemoryManager(manager)
{
    ...
    fSupportedParameters->add(XMLUni::fgDOMWRTMatchPrettyPrint);
}
                               ...
                               , int&               featureId) const
{
    ...
    else if (XMLString::equals(featName, XMLUni::fgDOMWRTMatchPrettyPrint))

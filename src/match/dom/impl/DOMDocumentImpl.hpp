...
#if !defined(MATCHC_INCLUDE_GUARD_DOMDOCUMENTIMPL_HPP)
#define MATCHC_INCLUDE_GUARD_DOMDOCUMENTIMPL_HPP
...
//
// ---------------------------------------------------------------------------
inline void * operator new(size_t amt, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocumentImpl *doc, MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager::NodeObjectType type)
{
    void *p = doc->allocate(amt, type);
    return p;
}

inline void * operator new(size_t amt, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocument *doc, MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager::NodeObjectType type)
{
    MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager* mgr=(MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager*)doc->getFeature(MATCH_CPP_NAMESPACE_QUALIFIER XMLUni::fgMatchcInterfaceDOMMemoryManager,0);
    void* p=0;
    if(mgr)
...
inline void * operator new(size_t amt, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocumentImpl *doc)
{
    void* p = doc->allocate(amt);
    return p;
}

inline void * operator new(size_t amt, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocument *doc)
{
    MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager* mgr=(MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager*)doc->getFeature(MATCH_CPP_NAMESPACE_QUALIFIER XMLUni::fgMatchcInterfaceDOMMemoryManager,0);
    void* p=0;
    if(mgr)
...
// ---------------------------------------------------------------------------
#if !defined(MATCH_NO_MATCHING_DELETE_OPERATOR)
inline void operator delete(void* /*ptr*/, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocumentImpl * /*doc*/, MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager::NodeObjectType /*type*/)
{
    return;
}
inline void operator delete(void* /*ptr*/, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocument * /*doc*/, MATCH_CPP_NAMESPACE_QUALIFIER DOMMemoryManager::NodeObjectType /*type*/)
{
    return;
}

inline void operator delete(void* /*ptr*/, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocumentImpl * /*doc*/)
{
    return;
}
inline void operator delete(void* /*ptr*/, MATCH_CPP_NAMESPACE_QUALIFIER DOMDocument * /*doc*/)
{
    return;
}
#endif

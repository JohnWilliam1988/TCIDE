...
#if !defined(MATCHC_INCLUDE_GUARD_DOMNODEIDMAP_HPP)
#define MATCHC_INCLUDE_GUARD_DOMNODEIDMAP_HPP
...
//  from the match utils project is not a paricularly good fit.
//
class DOMAttr;
class DOMDocument;

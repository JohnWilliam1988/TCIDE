...
bool DOMDocumentTypeImpl::isSupported(const XMLCh *feature, const XMLCh *version) const
{
    ...
    if(feature && *feature)
    {
        if((*feature==chPlus && XMLString::equals(feature+1, XMLUni::fgMatchcInterfaceDOMDocumentTypeImpl)) ||
           XMLString::equals(feature, XMLUni::fgMatchcInterfaceDOMDocumentTypeImpl))
            return true;
    }
...
{
    if(XMLString::equals(feature, XMLUni::fgMatchcInterfaceDOMDocumentTypeImpl))

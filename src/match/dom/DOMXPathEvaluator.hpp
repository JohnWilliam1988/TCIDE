...
#if !defined(MATCHC_INCLUDE_GUARD_DOMXPATHEVALUATOR_HPP)
#define MATCHC_INCLUDE_GUARD_DOMXPATHEVALUATOR_HPP
...
public:
     ...
     * Match-C extension <code>DOMXPathNSResolver::addNamespaceBinding()</code>.

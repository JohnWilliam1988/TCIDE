...
#if !defined(MATCHC_INCLUDE_GUARD_SAX2XMLREADER_HPP)
#define MATCHC_INCLUDE_GUARD_SAX2XMLREADER_HPP
...
public:
    ...
    /** ValScheme enum used in setValidationScheme
      ...
      *        parser->setFeature(XMLUni::fgMatchDynamic, false);
      *
      *    Val_Auto:
      *        parser->setFeature(XMLUni::fgSAX2CoreValidation, true);
      *        parser->setFeature(XMLUni::fgMatchDynamic, true);
      *
      * @see #setFeature
      */
    enum ValSchemes
